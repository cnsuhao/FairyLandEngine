...
class RenderAPID3D9 : public RenderAPI
{
public:
	Library		mD3DLibrary;
	...
	_void*		mD3D;
	_void*		mD3DDevice;
	_void*		mDefaultSwapChain;

	_void*		mDefaultRenderTarget;
	_void*		mDefaultDepthStencil;
	_void*		mCurrentRenderTarget;
	_void*		mCurrentDepthStencil;

public:
	RenderAPID3D9( );
	_dword CreateDeviceHelper( _handle window, _dword devicetouse, _dword devicetype, _bool vsync, _bool preservefpu );
	...
	virtual _void*	LockVertexBuffer( _void* vertexbuffer, _dword offset, _dword size, _dword flag );
	...
	virtual _void*	LockIndexBuffer( _void* indexbuffer, _dword offset, _dword size, _dword flag );
